...
(defun subspan-find-affine-coefficients (subspan center lambdas)
  (!v- (subspan-u subspan) center (v (subspan-vertices subspan) (subspan-origin subspan)))
...
(defun subspan-add (subspan vertex)
  (!v- (subspan-u subspan)
       ...
       (v (subspan-vertices subspan) (subspan-origin subspan)))
  (subspan-append-cloumn subspan)
...
(defun subspan-hessenberg-clear (subspan)
  )
...
(defstruct miniball
  ...
  (support (make-subspan) :type subspan)
...
(defun miniball-compute-dist-to-aff (miniball)
  (setf (miniball-dist-to-aff-square miniball)
        (subspan-shortest-vector-to-span (miniball-center miniball) (miniball-center-to-aff miniball)))
